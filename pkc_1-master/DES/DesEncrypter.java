...
public class DesEncrypter {
  ...
  public void decrypt(InputStream in, OutputStream out) {
	...
	public static void main(String[] args) {
		...
		try {
    	DesEncrypter TDES = new DesEncrypter(password, algorithm);
    	TDES.encrypt(new FileInputStream(inputfile), new FileOutputStream(inputfile + ".encrypted");
    	TDES.decrypt(new FileInputStream(inputfile), new FileOutputStream(inputfile + ".decrypted"));
		}
		catch (Exception e) {
