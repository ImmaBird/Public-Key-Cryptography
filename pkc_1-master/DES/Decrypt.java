...
public class Decrypt {
  ...
  private byte[] iv = new byte[]{
	...
	Decrypt(String passPhrase, String ALG) {
  ...
  public void decrypt(InputStream in, OutputStream out) {
	...
	public static void main(String[] args) {
      ...
      algorithm = "PBEWithMD5AndDES";
		...
		try {
    	Decrypt DES = new Decrypt(password, algorithm);
    	DES.decrypt(new FileInputStream(inputfile), new FileOutputStream(inputfile + ".decrypted"));
		}
		catch (Exception e) {
